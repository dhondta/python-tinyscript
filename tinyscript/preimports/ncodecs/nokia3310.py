# -*- coding: UTF-8 -*-
"""Nokia 3310 Codec - nokia3310 content encoding.
...
class Nokia3310Error(ValueError):
    pass


class Nokia3310DecodeError(Nokia3310Error):
    pass
...
def nokia3310_decode(text, errors="strict"):
    r = ""
    for i, t in enumerate(re.split(r"[_-]", text)):
        try:
            r += DECMAP[t]
        except KeyError:
            if errors == "strict":
...
codecs.add_codec("nokia3310", nokia3310_encode, nokia3310_decode,
                 r"nokia[-_]?3310$")
