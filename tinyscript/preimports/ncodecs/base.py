...
codecs.add_codec("base16", base16_encode, base16_decode, r"(?i)^base[-_]?16$")
...
codecs.add_codec("base32", base32_encode, base32_decode, r"(?i)^base[-_]?32$")
...
codecs.add_codec("base64", base64_encode, base64_decode, r"(?i)^base[-_]?64$")
...
if PY3:
    ...
    codecs.add_codec("base85", base85_encode, base85_decode,
                     r"(?i)^base[-_]?85$")
    ...
    codecs.add_codec("base100", base100_encode, base100_decode,
                     r"(?i)^base[-_]?100$")
